...
{
	/**
	 * Merge two arrays and keep the element type of the second array
	 * 
	 * @param array $array1
	 * @param array $array2
	 * 
	 * @return array
	 * @link http://www.php.net/manual/en/function.array-merge-recursive.php#92195 php.net comment
	 */
